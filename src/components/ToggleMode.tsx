  ...
  return (
    <div className="flex items-center justify-between bg-gray-bg rounded-md p-[1px] w-full">
      ...
      onClick={() => dispatch(switchMode())}
        ...
        <Eye width={20} height={20} color={!isConstructorMode ? 'stroke-iris' : 'stroke-gray-text'} />
      ...
      onClick={() => dispatch(switchMode())}
        className={`flex items-center gap-2 py-2 px-3
                  ${isConstructorMode ? 'bg-white rounded-[5px] ring-1 ring-outline' : ''}`}>
        <Selector width={20} height={20} color={isConstructorMode ? 'stroke-iris' : 'stroke-gray-text'} />
